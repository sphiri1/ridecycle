...
export class TechnicianLoginCreate extends Component {
    static displayName = TechnicianLoginCreate.name;
                            ...
                            <div className="login">
                                <div className="create-login-overlay">
                                    <div className="center-overlay" style={{ height: "85%" }} >
                                        ...
                                        <div className="links">
                                            ...
                                            <div className="register">
                                                <Link className="registerlink" to="/technician-create">Register</Link>
                                            </div>
                                    ...
                                    <div className="button-overlay">
                                        ...
                                        <Link className="create-account-button" to="/add-services">Log in</Link>
                                    </div>
